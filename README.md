...
graph TD
    ...
    M1 --> COG["⚙️ Cognitive AI Layer\nRule Engine + Knowledge Graph"]
    M2 --> COG
    M3 --> COG
    M4 --> COG
    M5 --> COG

    COG --> OUT["📋 Final Agricultural Report\n& Recommendations"]
```
...
```mermaid
graph TD
    IMG["📷 Leaf Image Input"]
    PRE["🔧 Image Preprocessing\n(Resize, Normalize, Augment)"]
    CNN["🧠 EfficientNet-B3 Backbone\n(Shared Feature Extractor)"]
    FV["📊 Shared Feature Vector"]

    CAT["🏷 Category Head\n(Disease / Pest / Deficiency)"]
    FG["🔬 Fine-Grained Head\n(Specific Class)"]

    XAI["🔥 Explainability Engine\nGrad-CAM | Saliency Maps | Feature Maps"]
    RPT["📄 Automated Diagnosis Report"]
...
graph LR
    ...
    M7B["🤖 Mistral-7B\n(Base Model)"]
    QL["🔧 QLoRA Adapter\n(Fine-tuned on AgriData)"]
    AK["📚 Egyptian Agricultural\nKnowledge Base"]
    OUT["📋 Personalized NPK\nRecommendation"]
...
```mermaid
graph TD
    HD["📅 Historical Crop Data\n(FAOSTAT)"]
    WD["🌦 Weather & Climate Data\n(ERA5)"]
    CF["⚙️ Feature Engineering\n(Lag Features, Rolling Stats)"]
    DC["🧹 Data Cleaning\n& Normalization"]
...
graph TD
    ...
    SC["🔍 Stress Classification\n(Normal / Moderate / Severe)"]
    ALERT["🚨 Early Warning Alert\n& Dashboard Notification"]

    SAT --> NDVI --> FE --> ML --> SC --> ALERT
```
...
```mermaid
graph TD
    CNN_OUT["🌿 CNN Prediction\n(Disease / Pest / Deficiency)"]
    CONF["📊 Confidence Score\n& Severity Level"]
    KG["🕸 Knowledge Graph\n(Disease → Treatment → Conditions)"]
    RULE["⚖️ Rule Engine\n(Agricultural Expert Rules)"]
    DX["🩺 Differential Diagnosis\n(Multi-hop Inference)"]
    TREAT["💊 Treatment Recommendation\n(Explainable + Cited)"]

    CNN_OUT --> CONF --> KG & RULE
    KG --> DX
    RULE --> DX
    DX --> TREAT
```
...
```mermaid
gantt
    title AI AgriVision Development Roadmap
    dateFormat  YYYY-MM
    section Version 1.0
    Plant Diagnosis Module       :done,    v1a, 2025-09, 2025-11
    AgriChat (Hybrid RAG)        :done,    v1b, 2025-10, 2025-12
    Fertilizer LLM               :done,    v1c, 2025-11, 2026-01
    Yield Prediction             :done,    v1d, 2025-12, 2026-02
    Early Warning System         :done,    v1e, 2026-01, 2026-03
    Cognitive AI Engine          :done,    v1f, 2026-02, 2026-04
    section Version 2.0
    Mobile App (iOS + Android)   :active,  v2a, 2026-07, 2026-12
    Cloud Synchronization        :         v2b, 2026-09, 2027-01
    GPS & Drone Integration      :         v2c, 2026-10, 2027-03
    Live Satellite Monitoring    :         v2d, 2026-11, 2027-04
    section Version 3.0
    Voice Assistant              :         v3a, 2027-04, 2027-08
    IoT Sensor Integration       :         v3b, 2027-06, 2027-10
    Reinforcement Learning Agent :         v3c, 2027-08, 2028-01
    Multi-Country Deployment     :         v3d, 2027-10, 2028-03
```
...
- 💼 **LinkedIn:** [LinkedIn - BADR ISLAM]([https://www.linkedin.com/in/mohamed-osama-kamel/](https://www.linkedin.com/in/badr-islam-4881b12a4/ar/?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BTPOWoDBtQ%2FaEn6FrhYhxXQ%3D%3D))
- 💼 **LinkedIn:** [LinkedIn - Mohamed Ali Shatla]([https://www.linkedin.com/in/mohamed-osama-kamel/](https://www.linkedin.com/in/mohamed-ali-shatla-88734b362/?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BGMka3F7tR%2BynvlYMTnHqdg%3D%3D))
- 💼 **LinkedIn:** [LinkedIn - ‏Ibrahim Amin‏]([https://www.linkedin.com/in/mohamed-osama-kamel/](https://www.linkedin.com/in/ibrahim-amin-aie0101010101/?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BKGQFkG8zRU%2BJt6YXeiwY%2Bg%3D%3D))
- 💼 **LinkedIn:** [LinkedIn - Mahmoud Ellakany]([https://www.linkedin.com/in/mohamed-osama-kamel/](https://www.linkedin.com/in/mahmoud-ashraf-hosny/?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3B1qwQM%2FK9RvS%2Bu1TIEZyxrQ%3D%3D))
- 💼 **LinkedIn:** [LinkedIn - Mohammed Ashraf]([https://www.linkedin.com/in/mohamed-osama-kamel/](https://www.linkedin.com/in/mohammed-ashraf-449a782a3/?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3Bin3NQNOYQt23fM%2Fr12oNMg%3D%3D))
